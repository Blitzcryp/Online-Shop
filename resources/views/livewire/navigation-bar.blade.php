<nav class="flex items-center justify-between flex-wrap bg-teal-700 p-1">
    ...
    @if (Route::has('login'))
        <div class="hidden px-6 py-4 sm:block text-lg">
            @auth
                <a href="{{ url('/dashboard') }}" class="inline-block text-lg px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Dashboard</a>
            @else
